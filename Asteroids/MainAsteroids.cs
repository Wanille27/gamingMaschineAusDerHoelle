...
namespace Starter.gamingMaschineAusDerHoelle.Asteroids;

public partial class MainAsteroids : Node2D {
	public MenuPanel MenuPanelI { get; set; }
	...
	public override void _Ready() {
		...
		//this._screen._Ready();
		//var playerShipScene = GD.Load<PackedScene>("res://asteroids/PlayerShipSleek1.tscn");
		...
		var asteroidLargeScene = GD.Load<PackedScene>("res://gamingMaschineAusDerHoelle/Asteroids/Asteroid_Large.tscn");
		...
		var asteroidMediumScene = GD.Load<PackedScene>("res://gamingMaschineAusDerHoelle/Asteroids/Asteroid_Medium.tscn");
		...
		var asteroidSmallScene = GD.Load<PackedScene>("res://gamingMaschineAusDerHoelle/Asteroids/Asteroid_Small.tscn");
		...
		this.GameOver += () => {
			...
			this._running = false;
			this.MenuPanelI.EmitSignal("CloseGame");
		};
